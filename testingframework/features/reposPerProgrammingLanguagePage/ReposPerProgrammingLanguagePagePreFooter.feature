@SanityTest
Feature: Repository per programming language pre footer feature
  Scenario: Validate the pre footer of the Repository per programming language page
    Given User is on the "https://webuildsg.github.io/data/dataset/repos-per-programming-language/" page to validate pre footer container features
