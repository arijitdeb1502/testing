@SanityTest
Feature: DataPage header styles features
	Scenario: Validate header styles 
	Given User moves on to the "https://webuildsg.github.io/data/dataset/repos-per-programming-language/" page for validating header styles
